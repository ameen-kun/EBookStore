...
import lockicon from'../assets/images/outline_lock_black_24dp.png';
                    ...
                    <Form  noValidate onSubmit={submitForm}>
                        ...
                        <Row className="mb-3">
                            <Form.Group controlId="uname">
                                ...
                                <InputGroup className="mb-3">
                                    <InputGroup.Text id="basic-addon1"><img src={usericon} alt="@"/></InputGroup.Text>
                        ...
                        <Row className="mb-3">
                            <Form.Group controlId="password">   
                                ...
                                <InputGroup className="mb-3">
                                    <InputGroup.Text id="basic-addon1"><img src={lockicon} alt="*"/></InputGroup.Text>
